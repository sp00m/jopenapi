...
@JsonSubTypes({ @JsonSubTypes.Type(name = "category_b", value = jopenapi.test.more_features.oneof.B.class),
		@JsonSubTypes.Type(name = "category_c", value = jopenapi.test.more_features.oneof.C.class) })
