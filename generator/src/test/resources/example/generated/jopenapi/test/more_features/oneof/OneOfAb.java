...
@JsonSubTypes({ @JsonSubTypes.Type(name = "category_a", value = jopenapi.test.more_features.oneof.A.class),
		@JsonSubTypes.Type(name = "category_b", value = jopenapi.test.more_features.oneof.B.class) })
